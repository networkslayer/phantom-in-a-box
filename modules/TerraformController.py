...
class TerraformController(IEnvironmentController):
    ...
    def build(self):
        ...
        if not return_code:
           self.log.info("phantom-in-a-box has been boxed..... using terraform successfully")
    ...
    def destroy(self):
        ...
        self.log.info("phantom-in-a-box has been destroyed using terraform successfully")
    ...
    def list_machines(self):
        ...
        if len(response) > 0:
            ...
            print("ERROR: Can't find configured EC2 Phantom Instances in AWS.")
        print()
